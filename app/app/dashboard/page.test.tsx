    ...
    listAllMock.mockResolvedValue([
      {
        ...
        responseText: "Amazon and eBay are great options for shoppers.",
        ...
        analysisPayload: {
          ...
          entityDetection: {
            ...
            claims: ["Amazon and eBay are great options for shoppers"],
            sentiment: "positive",
            rawText: "Amazon and eBay are great options for shoppers.",
